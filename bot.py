...
async def help(ctx):
    ...
    helpreaction = await client.wait_for_reaction(['1\u20e3'], message=help2, message=help3)   
    await client.edit_message(help2,help3, embed=help1)
    helpreaction2 = await client.wait_for_reaction(['2\u20e3'], message=help1, message=help3)
