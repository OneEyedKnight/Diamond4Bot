...
async def casino(ctx):
    ...
    bigger = await client.wait_for_reaction(['\U0001f1e7'],['\U0001f1f8'],message=casinostart)     
    await client.edit_message(casinostart, "Bigger? Alright! Starting the roll!"(check=['\U0001f1f8']))
    await client.edit_message(casinostart, "Smaller? Alright! Starting the roll!"(check=['\U0001f1e7']))
