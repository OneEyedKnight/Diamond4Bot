...
async def help(ctx):
    ...
    await client.add_reaction(help1, '\U00000031')
    await client.add_reaction(help1,'\U00000032')
    await client.add_reaction(help1,'\U00000033')
    helpreaction2 = await client.wait_for_reaction(['\U00000032'], message=help1)
